...
public class NewProduct extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        productCode = jTextField1.getText();
        productTitle = jTextField2.getText();
        productDescription = jTextField3.getText();
        unitPrice = jTextField4.getText();
        quantity = jTextField5.getText();
        try {
            Integer.parseInt(unitPrice);
            Integer.parseInt(quantity);
            newItem = new BBStockItem(productCode, productTitle, productDescription, Integer.parseInt(unitPrice), Integer.parseInt(quantity));
            this.setVisible(false);
       }
       catch (NumberFormatException e) {
            //check number
           JOptionPane.showMessageDialog(NewProduct.this, String.format("Invalid number formate.Please re-enter the number"));                 
       }
